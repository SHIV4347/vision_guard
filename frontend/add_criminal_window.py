...
class AddCriminalWindow(QWidget):
    ...
    def submit_form(self):
        try:
            ...
            photo_file = DummyFile(self.image_path)
            result = add_criminal(name=name, age=age, address=address, crimes=crimes, image_path=self.image_path)
